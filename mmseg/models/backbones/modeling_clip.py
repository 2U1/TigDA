...
class CLIPTextTransformer(nn.Module):
    ...
    def forward(
        ...
        embedded_tokens: Optional[torch.Tensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        input_embeddings, position_embeddings = self.embeddings(input_ids=input_ids, position_ids=position_ids)

        if embedded_tokens is not None:
            hidden_states = embedded_tokens + position_embeddings
